                ...
                <div class="bg-gray-50 rounded-xl p-6 border-l-4 border-blue-500">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-lg font-bold text-gray-800">{{ number_format($result['confidence'] ?? 0, 1) }}%</span>
                        </div>

                        <!-- Confidence Bar -->
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="confidence-bar h-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-500"
